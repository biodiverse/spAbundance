...
extern "C" {
  ...
  SEXP svcMsAbundGaussianNNGPPredict(SEXP coords_r, SEXP J_r, SEXP family_r,
    ...
    PROTECT(y0_r = Rf_allocMatrix(REALSXP, J0N, nSamples)); nProtect++;
    PROTECT(mu0_r = Rf_allocMatrix(REALSXP, J0N, nSamples)); nProtect++;
    PROTECT(w0_r = Rf_allocMatrix(REALSXP, J0qpTilde, nSamples)); nProtect++;
    double *y0 = REAL(y0_r);
