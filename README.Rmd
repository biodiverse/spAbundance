...
`spAbundance` is in active development. The functionality currently implemented is not yet fully tested, and should be used with caution. To download the development version of the package, you can use `devtools` as follows:  
